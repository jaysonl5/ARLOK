...
/* {# inline_template_start #}<h2 id="term-anchor-{{tid}}">{{name}}</h2> */
class __TwigTemplate_5b2f09d8985051e990e3f07b685b0fd5d62e87ceb096b08c2bba3fa96a983b73 extends Twig_Template
{
    ...
    {
        return "{# inline_template_start #}<h2 id=\"term-anchor-{{tid}}\">{{name}}</h2>";
    }
    ...
    {
        return new Twig_Source("", "{# inline_template_start #}<h2 id=\"term-anchor-{{tid}}\">{{name}}</h2>", "");
    }
}
