...
/* {# inline_template_start #}<a href="#term-anchor-{{ tid }}">{{name}}</a> */
class __TwigTemplate_57d1b64a23ba1bc6c30e8484a7cc0be5166e2856f045b3c72189af6de809546f extends Twig_Template
{
    ...
    {
        return "{# inline_template_start #}<a href=\"#term-anchor-{{ tid }}\">{{name}}</a>";
    }
    ...
    {
        return new Twig_Source("", "{# inline_template_start #}<a href=\"#term-anchor-{{ tid }}\">{{name}}</a>", "");
    }
}
