...
(function ($) {
  ...
  function initScrollTo() {
    ...
    $btnsNav.on('click touch', function(e){
      ...
      $('html, body')
        .animate(
          {scrollTop: $('h2[id="'+this.hash.slice(1)+'"]').offset().top - 20},
          800
        );
    });
  }
  ...
  function initMobileNav() {
    ...
    if ($navWrapper.hasClass('processed')) return;

    $navWrapper.addClass('processed');
  ...
  function initcollapsibleBlock() {
    ...
    if ($collapsibleBlock.hasClass('processed')) return;

    $collapsibleBlock.addClass('processed');
  ...
  function initFormQuote() {
    ...
    var $fieldAssociationInput = $wrapper.find('.form-item-association-name');
    ...
    var $fieldReferredInput = $wrapper.find('.form-item-persons-name');
